...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:       'Freelance Web Developer Berlin — Junaid Builds',
    description: 'Bespoke websites and web applications for businesses that want to stand out. No templates. No agency markup.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body className={`${inter.variable} ${mono.variable} ${display.variable} font-sans bg-canvas text-body antialiased`}>
        {children}
      </body>
    </html>
  )
