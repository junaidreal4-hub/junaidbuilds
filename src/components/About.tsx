...
export default function About() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // sticky pin on the whole section while scrolling through
  ...
  return (
    ...
    >
      {/* sticky wrapper — pins while user scrolls */}
      <div ref={stickyRef}>
      ...
      {/* Full-viewport-width dark banner — slightly overlaps sticky content */}
      <div
        ref={bannerRef}
        style={{
          position: 'relative',
          marginTop: '-2rem',
          marginLeft: 'calc(-1 * clamp(1.5rem,5vw,5rem))',
      ...
      >
        <p
          ...
          style={{
            fontFamily: 'var(--font-sans)',
            fontWeight: 900,
            /* fit-content to exact viewport width */
