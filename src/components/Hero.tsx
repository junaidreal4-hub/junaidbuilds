...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen flex flex-col pt-16 overflow-hidden bg-[#080808]">
      ...
      {/* Heading — flex-1 centres it vertically */}
      <div className="relative z-20 flex-1 flex items-center min-h-0">
        <div className="container-width w-full">

          <div className="overflow-hidden">
            <p className="font-sans font-black uppercase text-white leading-[0.9] tracking-tighter opacity-0 animate-fade-up"
              style={{ fontSize: 'clamp(2.4rem, 7.5vw, 7.5rem)', animationDelay: '0ms', animationFillMode: 'forwards' }}>
              I Build
            </p>
          </div>
          <div className="overflow-hidden">
            <p className="font-sans font-black uppercase leading-[0.9] tracking-tighter opacity-0 animate-fade-up flex flex-wrap items-baseline gap-x-4"
              style={{ fontSize: 'clamp(2.4rem, 7.5vw, 7.5rem)', animationDelay: '80ms', animationFillMode: 'forwards' }}>
          ...
          <div className="overflow-hidden mb-6">
            <p className="font-sans font-black uppercase text-white leading-[0.9] tracking-tighter opacity-0 animate-fade-up"
              style={{ fontSize: 'clamp(2.4rem, 7.5vw, 7.5rem)', animationDelay: '160ms', animationFillMode: 'forwards' }}>
              That Work.
            </p>
          </div>

          <p className="font-mono text-[11px] md:text-xs text-white/40 uppercase tracking-widest opacity-0 animate-fade-up mb-8"
            style={{ animationDelay: '260ms', animationFillMode: 'forwards' }}>
            Full-Stack Developer &amp; Designer  ·  Berlin, Germany
          </p>

          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 border-t border-white/[0.08] opacity-0 animate-fade-up"
            ...
            {STATS.map((s, i) => (
              <div key={s.label} className={`py-4 flex flex-col gap-1 ${
                ...
                <span className="font-sans font-black text-white text-2xl md:text-3xl leading-none">
      ...
      {/* Bottom bar */}
      <div className="relative z-20 container-width py-4 border-t border-white/[0.06] shrink-0">
